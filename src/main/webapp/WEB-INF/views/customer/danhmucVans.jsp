...
<!-- menu4 -->
<div class="menu4" style="margin-top: 50px">
	<img  src="${base }/images/gtvans.jpg">
</div>
<!-- /menu4 -->
<!-- menu5 -->
<div class="menu5">
...
<section class="py-5">
	 ...
	 <c:forEach items="${vans.data}" var="products">
 ...
 position: relative;
  ...
  text-align: center;}
	...
	$( document ).ready(function() {
		...
		$("#paging").pagination({
			currentPage: ${vans.currentPage},
	        items: ${vans.totalItems},
	        itemsOnPage: 8,
