...
@Service
public class DanhMuc_Service  extends BaseService<Product>{
	...
	public PagerData<Product> search(ProductSearchModel searchModel, String name) {
...
//			}
		...
		if(name.equals("Giỏ Hoa Quả")) {
		//lấy danh mục converse
			sql += " and p.category_id= 46 ";
		}
		else if(name.equals("Vans"))
		{
			sql += " and p.category_id=43 ";
		}
		else if(name.equals("Dép"))
		{
			sql += " and p.category_id=45 ";
		}
		else if(name.equals("Phụ Kiện"))
		{
			sql += " and p.category_id = 42";
		}
